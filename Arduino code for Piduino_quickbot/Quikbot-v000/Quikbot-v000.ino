...
void loop()
{
  ...
  long PWM_left_inp=0, PWM_right_inp=0, ENQ_left=0, ENQ_right=0, ENC_left_delta = 0, ENC_right_delta=0;
  ...
  float PI=3.1415, VEL_left = 0.0, VEL_right= 0.0;
      ...
      switch (command_code) {
        ...
        case PWM_set: {
          ...
          If (PWM_left_inp == 0 && PWM_right_inp == 0) {
            CMD_response = INT_zero + " \n";
            Serial.write(CMD_response);
            break;
          }
          if (PWM_right_inp == 0) { 
            CMD_response = INT_one + " \n";
            Serial.write(CMD_response);
            break;
          }
        ...
        case IRVAL_enq: {
          ...
          CMD_response = CMD_ok + 5 + ir0 + ir1 + ir2 + ir3 + in4 + " \n";
          Serial.write(CMD_response);
          break;
        }
        case CHECK: {
